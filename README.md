...
| <img src="assets/Untitled%2010.png" height="40" align="left">                                                                                                                                                        |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| <img src="assets/Untitled%2011.png" height="40" align="left">                                                                                                      |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| <ul><li>특정 유저가 메세지 브로커에 웹소켓 연결 요청 시, JWT 토큰을 파싱하여</li><li>해당 유저가 음악 작업실의 멤버인지 판단하는 인증 인터셉터 계층 추가</li></ul> |

| <img src="assets/Untitled%2012.png" height="40" align="left">                                                                                                                   |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
