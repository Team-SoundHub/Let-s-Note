  ...
  return (
    <div className={"flex justify-center items-center"}>
      <button
        ...
        className="flex flex-col justify-center bg-[#49c5b6] items-center w-16 h-16 rounded-md my-1 p-1 hover:opacity-70"
      >
        <div>
          <svg
            className="w-10 h-10"
        ...
        <div className="text-white font-bold text-xs">악보 찾기</div>
      </button>
    </div>
  );
};
